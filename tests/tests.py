...
def test_formatter_plain():
    with open("tests/answers/_formatter_plain.txt", "r") as f:
        answer = f.read()
    result_JSON_stylish = generate_diff("tests/fixtures/json_files/file1recursive.json", "tests/fixtures/json_files/file2recursive.json", "plain")
    result_YAML_stylish = generate_diff("tests/fixtures/yaml_files/file1recursive.yml", "tests/fixtures/yaml_files/file2recursive.yml", "plain")
    assert result_JSON_stylish == answer
    assert result_YAML_stylish == answer
...
def test_formatter_json():
    with open("tests/answers/_formatter_JSON.txt", "r") as f:
        answer = f.read()
    result_JSON_stylish = generate_diff("tests/fixtures/json_files/file1recursive.json", "tests/fixtures/json_files/file2recursive.json", "json")
    result_YAML_stylish = generate_diff("tests/fixtures/yaml_files/file1recursive.yml", "tests/fixtures/yaml_files/file2recursive.yml", "json")
    assert result_JSON_stylish == answer
    assert result_YAML_stylish == answer
